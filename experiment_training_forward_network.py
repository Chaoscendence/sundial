...
net = ForwardNetwork(settings=lenet_settings)

folder_name = "trained_models/forward_networks/"
subfolder_name = "natural_materials_forward_HG_MSELoss"
...
settings['results_dir'] = os.path.join(folder_name, "ResultsByMaterials_" 
                                        + subfolder_name)
...
def main():
    ...
    X_train_dp, X_valid_dp, X_test_dp, Y_train_dp, Y_valid_dp, Y_test_dp = \
        ds_dp.train_valid_test_split_randomly(
            ...
            task='forward')
    X_train, X_valid, X_test = X_train_dp, X_valid_dp, X_test_dp
    Y_train, Y_valid, Y_test = Y_train_dp, Y_valid_dp, Y_test_dp
    """
